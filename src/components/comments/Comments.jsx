...
export default function Comments({ comments, handleCommentVoteClick, commentVoteHistory }) {

    const activeUser = useActiveUser()
    const commentsList = comments.map(({ id, title, body, vote_score, comment_creator, owner_id }, i) => {
